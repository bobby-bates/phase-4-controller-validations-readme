class BirdsController < ApplicationController
  ...
  def render_unprocessable_entity_response(invalid)
    # NOTE: Using full_messages to get preformatted error messages on front end.
    # Omitting gives you invalid attrs as KEYS -
    # these can be used to find the matching input on a form
